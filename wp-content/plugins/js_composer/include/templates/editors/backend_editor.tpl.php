...
<input type="hidden" id="wpb_vc_loading" name="wpb_vc_loading" value="<?php _e("Loading, please wait...", "js_composer") ?>" />
<input type="hidden" id="wpb_vc_loading_row" name="wpb_vc_loading_row" value="<?php _e("Crunching...", "js_composer") ?>" />
