...
<?php global $wp_query, $element_options;?>
		<!-- content 
			================================================== -->
		<div id="content" <?php if(element_thumbnail_url('')!=''){ ?> class="banner-photo2" style="background-image: url(<?php echo esc_attr(element_thumbnail_url('')); ?>);"<?php } ?>>
				...
				<div class="container">
					<div class="row">
						...
						<div class="main-page <?php echo esc_attr($page_class); ?>">
							<div class="blog-box <?php if(element_thumbnail_url('')!=''){ ?> blog-alternative <?php } ?>">
								<?php 
									if(is_front_page()) {
