<?php 
/*
*Template Name: Portfolio Description Masonry
*/
?>
<?php get_header(); ?>
<?php global $wp_query;?>
		...
		<div id="content">
			...
			<!-- portfolio-page
				================================================== -->
			<div class="section-content portfolio-page description masonry-style">
				<div class="container">
					<div class="row">
						...
						<ul class="filter">
							...
							<div class="portfolio-box masonry <?php if(get_post_meta($wp_query->get_queried_object_id(), '_cmb_page_fullwidth', true)!="yes"){ ?> col-3 <?php }else{ ?> col-4<?php } ?>">
								...
								?>
								<div class="work-post <?php echo esc_attr($item_classes); ?> <?php echo get_post_meta(get_the_ID(), "_cmb_portfolio_grid", true); ?>">
									<div class="work-gal">
									...
									<div class="work-content">
										...
										<p><?php echo do_shortcode(element_excerpt($limit=10)); ?></p>
