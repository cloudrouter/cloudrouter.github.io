				...
				<div class="container">
					<div class="row">
						...
						<div class="main-page <?php echo esc_attr($page_class); ?>">
							...
							<div class="portfolio-box masonry col-3<?php if(get_post_meta($wp_query->get_queried_object_id(), '_cmb_page_fullwidth', true)!="yes"){ ?>-sidebar<?php }?>">
