<?php 
/*
*Template Name: Portfolio Masonry Fullscreen
*/
?>
<?php get_header(); ?>
<?php global $wp_query;?>
		...
		<div id="content">
			...
			<!-- portfolio-page
				================================================== -->
			<div class="section-content portfolio-page masonry-style">
				<div class="container">
					<ul class="filter">
				...
				<div class="portfolio-box masonry fullscreen">
					...
					?>
					<?php
						if(get_post_meta(get_the_ID(), '_cmb_m_thumb', true)!=''){
							$img = get_post_meta(get_the_ID(), '_cmb_m_thumb', true);
						}else{
							$img = element_thumbnail_url('');
						}
					?>
					<div class="work-post <?php echo esc_attr($item_classes); ?> <?php echo get_post_meta(get_the_ID(), "_cmb_portfolio_grid2", true); ?>">
