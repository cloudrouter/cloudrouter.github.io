<?php 
/*
*Template Name: Portfolio Description 2Col
*/
?>
<?php get_header(); ?>
<?php global $wp_query;?>
				...
				<div class="container">
					<div class="row">
						...
						<div class="main-page <?php echo esc_attr($page_class); ?>">
							...
							<div class="portfolio-box masonry col-2<?php if(get_post_meta($wp_query->get_queried_object_id(), '_cmb_page_fullwidth', true)!="yes"){ ?>-sidebar<?php }?>">
							...
							?>
								<div class="work-post <?php echo esc_attr($item_classes); ?>">
									<div class="work-gal">
										<img src="<?php echo esc_attr(bfi_thumb($img, array('width'=>583, 'height'=> 361))); ?>" alt="<?php the_title(); ?>">
										<div class="hover-box">
									...
									<div class="work-content">
										...
										<p><?php echo do_shortcode(element_excerpt($limit=25)); ?></p>
